...
<!-- General-memeber -->
<section class="committee-section pt-4">
    <div class="container">
        <!-- Row  start -->
        <div class="row justify-content-center committee-member-all-item-wrapper">
            <div class="col-md-7 m-auto">
                ...
                <div class="term-service">
                    ...
                    <form action="{{ route('subscribe-user-profile-payment') }}" method="post" id="paid-invoice-form">
                        @csrf
                        <div class="py-5 col-md-8 m-auto make-payment-page" id="paidInvoice">
