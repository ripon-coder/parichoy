                            ...
                            <tbody>
                                @if($allusers->count() > 0)
                                    @foreach ($allusers as $alluser)
                                        ...
                                        @endphp
                                        @if(isset($alluser->duration) && $duration < $diff)
                                            <tr>
                                                <td>{{ $alluser->index + 1 }}</td>
                                                ...
                                                <td>
                                                    @if ($alluser->status === 1)
                                                        <a class="badge badge-info" href="{{ route('admin.subscribe-status', ['id'=> $alluser->id]) }}" data-toggle="tooltip" data-placement="top" title="Make Inactive">Active</a>
                                                    @else
                                                        <a class="badge badge-warning" href="{{ route('admin.subscribe-status', ['id'=> $alluser->id]) }}" data-toggle="tooltip" data-placement="top" title="Make Active">Inactive</a>
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <div class="action-btns">
                                                        ...
                                                        <a class="data-edit-btn" data-toggle="tooltip" data-placement="top" title="Send Notify" href="{{ route('admin.expired-user-mail-notify', $alluser->id) }}">
